...
cls
echo ------------------------------------------------
echo I        VÉRIFICATION SYSTÈME WINDOWS          I
echo I----------------------------------------------I
echo I  [1] Vérification fichiers système (SFC)     I
echo I  [2] Réparation image Windows (DISM)         I
echo I  [3] Vérification complète (SFC + DISM)      I
echo I  [4] Voir rapport détaillé (CBS.log)         I
echo I  [0] Quitter                                 I
echo ------------------------------------------------
echo.
